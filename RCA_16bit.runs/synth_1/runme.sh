...
HD_PWD='C:/Users/harsh/RCA_16bit/RCA_16bit.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log RCA_16bit.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source RCA_16bit.tcl
